...
$smarty->assign('addlink', '<a href="#" onclick="addObject(this);return false;">'.$admintheme->DisplayImage('icons/system/newobject.gif', $this->Lang('add'), '', '', 'systemicon').' '.$this->Lang('add').'</a>');
...
while ($dbresult && $row = $dbresult->FetchRow()){
	...
	$object->deletelink = '<a href="#" onclick="deleteObject(this);return false">'.$admintheme->DisplayImage('icons/system/delete.gif', $this->Lang('delete'), '', '', 'systemicon').'</a>';
	$objects[] = $object;
}
